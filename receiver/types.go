...
type GetServiceCapabilitiesResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl GetServiceCapabilitiesResponse"`
...
type GetReceiversResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl GetReceiversResponse"`

	// A list of all receivers that currently exist on the device.
	Receivers []*Receiver `xml:"Receivers,omitempty" json:"Receivers,omitempty"`
}
...
type GetReceiverResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl GetReceiverResponse"`

	// The details of the receiver.
	Receiver *Receiver `xml:"Receiver,omitempty" json:"Receiver,omitempty"`
}
...
type CreateReceiverResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl CreateReceiverResponse"`
...
type DeleteReceiverResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl DeleteReceiverResponse"`
}
...
type ConfigureReceiverResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl ConfigureReceiverResponse"`
}
...
type SetReceiverModeResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl SetReceiverModeResponse"`
}
...
type GetReceiverStateResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/receiver/wsdl GetReceiverStateResponse"`

	// Description of the current receiver state.
	ReceiverState *ReceiverStateInformation `xml:"ReceiverState,omitempty" json:"ReceiverState,omitempty"`
}
...
type Capabilities struct {
	...
	RTP_Multicast bool `xml:"RTP_Multicast,attr,omitempty" json:"RTP_Multicast,omitempty"`

	// Indicates that the device can receive RTP/TCP streams

	RTP_TCP bool `xml:"RTP_TCP,attr,omitempty" json:"RTP_TCP,omitempty"`
	...
	SupportedReceivers int32 `xml:"SupportedReceivers,attr,omitempty" json:"SupportedReceivers,omitempty"`

	// The maximum allowed length for RTSP URIs (Minimum and default value is 128 octet).

	MaximumRTSPURILength int32 `xml:"MaximumRTSPURILength,attr,omitempty" json:"MaximumRTSPURILength,omitempty"`
}
...
type FieldOfView struct {
	...
	Hfov float32 `xml:"hfov,attr,omitempty" json:"hfov,omitempty"`

	// Vertical field-of-view in degrees.

	Vfov float32 `xml:"vfov,attr,omitempty" json:"vfov,omitempty"`
}
...
type PTZStatus struct {
	...
	//
	FieldOfView *FieldOfView `xml:"FieldOfView,omitempty" json:"FieldOfView,omitempty"`
...
type VideoEncoder2Configuration struct {
	*ConfigurationEntity
	...
	Signed bool `xml:"Signed,attr,omitempty" json:"Signed,omitempty"`
}
...
type PTZFilter struct {
	...
	FieldOfView bool `xml:"FieldOfView,omitempty" json:"FieldOfView,omitempty"`
}
...
type PTZStatusFilterOptions struct {
	...
	FieldOfViewSupported bool `xml:"FieldOfViewSupported,omitempty" json:"FieldOfViewSupported,omitempty"`
...
type FrequencyDecibelPair struct {
	...
	CenterFrequency int32 `xml:"CenterFrequency,omitempty" json:"CenterFrequency,omitempty"`

	// Decibel value associated with the center frequency.
	Decibel float32 `xml:"Decibel,omitempty" json:"Decibel,omitempty"`
...
type EQPreset struct {
	...
	ScheduleToken string `xml:"ScheduleToken,omitempty" json:"ScheduleToken,omitempty"`

	// Indicates whether the device allows changing the decibel level for frequencies. (Readonly)
	IsFrequencyDecibelEditable bool `xml:"isFrequencyDecibelEditable,omitempty" json:"isFrequencyDecibelEditable,omitempty"`

	// List of frequency decibel pairs, each defined by a center frequency and its corresponding decibel value.
	FrequencyDecibelPair []*FrequencyDecibelPair `xml:"FrequencyDecibelPair,omitempty" json:"FrequencyDecibelPair,omitempty"`
...
type AudioOutputConfigurationOptions struct {
	...
	EQPresetScheduleSupport bool `xml:"EQPresetScheduleSupport,omitempty" json:"EQPresetScheduleSupport,omitempty"`

	// List of supported EQPresets.
	EQPresets []*EQPreset `xml:"EQPresets,omitempty" json:"EQPresets,omitempty"`
...
type MulticastAudioDecoderConfiguration struct {
	*ConfigurationEntity
	...
	//
	Multicast *MulticastReceiverConfiguration `xml:"Multicast,omitempty" json:"Multicast,omitempty"`
	...
	//
	RTPPayloadType int32 `xml:"RTPPayloadType,omitempty" json:"RTPPayloadType,omitempty"`
	...
	//
	MediaFormatParameters string `xml:"MediaFormatParameters,omitempty" json:"MediaFormatParameters,omitempty"`
	...
	//
	SRTPPreSharedParameters *SRTPPreShared `xml:"SRTPPreSharedParameters,omitempty" json:"SRTPPreSharedParameters,omitempty"`
}
...
type SRTPPreShared struct {
	...
	//
	SRTPPSK string `xml:"SRTPPSK,omitempty" json:"SRTPPSK,omitempty"`
	...
	//
	SecureStreamingProtocolAlgorithm string `xml:"SecureStreamingProtocolAlgorithm,omitempty" json:"SecureStreamingProtocolAlgorithm,omitempty"`
	...
	//
	ROCExtMapID int32 `xml:"ROCExtMapID,omitempty" json:"ROCExtMapID,omitempty"`
...
type MulticastReceiverConfiguration struct {
	...
	SourceSpecificMulticast *IPAddress `xml:"SourceSpecificMulticast,omitempty" json:"SourceSpecificMulticast,omitempty"`
...
type MulticastAudioDecoderConfigurationOptions struct {
	...
	EncodingOptions *AudioDecoder2Options `xml:"EncodingOptions,omitempty" json:"EncodingOptions,omitempty"`

	//
	// Specifies the priority range as an integer. This indicates the priority level for audio configuration.
	//
	PriorityRange *IntRange `xml:"PriorityRange,omitempty" json:"PriorityRange,omitempty"`
	...
	//
	SecureStreamingProtocolAlgorithms *StringList `xml:"SecureStreamingProtocolAlgorithms,omitempty" json:"SecureStreamingProtocolAlgorithms,omitempty"`
	...
	//
	AudioOutputTokens *StringList `xml:"AudioOutputTokens,omitempty" json:"AudioOutputTokens,omitempty"`
...
type AudioDecoder2Options struct {
	...
	// particularly when it is fixed for a specific audio encoding as defined in .
	//
	RTPPayloadType int32 `xml:"RTPPayloadType,omitempty" json:"RTPPayloadType,omitempty"`
...
type UserRole struct {
	...
	Functions *StringList `xml:"Functions,omitempty" json:"Functions,omitempty"`
}
...
type UserExtension struct {
	...
	Roles *StringList `xml:"Roles,omitempty" json:"Roles,omitempty"`
...
type AsymmetricEncryption struct {
	...
	KeyRotationDuration *Duration `xml:"KeyRotationDuration,omitempty" json:"KeyRotationDuration,omitempty"`
...
type RecordingEncryption struct {
	...
	AsymmetricEncryption *AsymmetricEncryption `xml:"AsymmetricEncryption,omitempty" json:"AsymmetricEncryption,omitempty"`
...
type RecordingTargetConfiguration struct {
	...
	SegmentDurationOverride struct {
		...
		Expiration *Duration `xml:"Expiration,omitempty" json:"Expiration,omitempty"`
	} `xml:"SegmentDurationOverride,omitempty" json:"SegmentDurationOverride,omitempty"`
...
func NewReceiverPort(client *soap.Client) ReceiverPort {
	return &receiverPort{
		client: client,
	}
}
